...
| Intent                                     | Params                                                            | Notes                                                                                                                                                                                                        |
| ------------------------------------------ | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `send_prompt`                              | `{ "prompt": "...", "dismiss_welcome"?: true }`                   | Streams the prompt as ordinary input and presses Enter. `dismiss_welcome` first sends Enter to clear Claude Code's first-launch welcome panel. Sets `last_intent = "prompt_submitted"`.                       |
